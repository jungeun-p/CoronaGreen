...
public class NaverLoginBo {
	...
	public OAuth2AccessToken getAccessToken(HttpSession session, String code, String state) throws IOException {
		...
		/*
		 * System.out.println("에세스토큰에서 세션 : " + session);
		 * System.out.println("에세스토큰에서 코드 : " + code);
		 * System.out.println("에세스토큰에서 스테이츠 : " + state); System.out.println("세션 스테이츠" +
		 * sessionState); System.out.println(StringUtils.pathEquals(sessionState,
		 * state));
		 */
		...
		if (StringUtils.pathEquals(sessionState, state)) {
			...
			// System.out.println("에세스토큰은 과연!!!!!!!!!!!!!!!!!" + accessToken);
			return accessToken;
		}
		// System.out.println("펄스구나?");
		return null;
	}
	...
	public String getUserProfile(OAuth2AccessToken oauthToken) throws IOException {
		...
		// System.out.println("리퀘트스다!!!" + request);
		// System.out.println("토큰이다!!!" + oauthToken);
