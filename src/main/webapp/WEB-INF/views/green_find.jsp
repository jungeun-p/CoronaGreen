				...
				<div class="wrap1">
					...
					<div class="find__id__certification find__all">
						...
						<div class="find__id__cer__input">
							<input id="id__email" name="text" class="find__id__cer__text"
								type="text" />
						</div>
						<div class="find__id__cer__button">
							<input id="emailsend" class="find__id__cer__button__input"
								type="button" value="CONFIRM" disabled="disabled" />
						</div>
					</div>
			...
			<form action="changepw.do" method="post" class="wrap__find__pw">
				<div class="wrap3">
					...
					<div class="find__pw__id find__all">
						...
						<div class="find__pw__id__input">
							<input name="id" id="pw__id" class="find__pw__id__text"
								type="text" />
						</div>
					</div>
					...
					<div class="find__pw__certification find__all">
						...
						<div class="find__pw__cer__button">
							<input id="emailsend2" class="find__pw__cer__button__input"
								type="button" value="CONFIRM" disabled="disabled" />
						</div>
					</div>
				...
				<div class="find__pw__certification find__all">
					...
					<div class="find__pw__cer__input code__text">
						<input id="pw__email__code" class="find__pw__cer__text"
							type="text" disabled="disabled" />
					</div>
					<div class="find__pw__cer__button code__button">
						<input id="search" class="find__pw__search__input" type="submit"
