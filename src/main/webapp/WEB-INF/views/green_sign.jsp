		...
		<div class="reg_border">
			...
			<div class="divID">
				...
				<div class="ID_2 ID_common">
					<input type="text" name="ID" id="myid" placeholder="아이디를 입력하세요."
						required="required" title="n" />
				</div>
				<div class="ID_3 ID_common">
					<input type="button" value="중복체크" id="idchk" onclick="idCheck();" />
				</div>
			</div>
			...
			<div class="divPW">
				...
				<div class="PW_2 PW_common">
					...
					<span id="pw_text">8~15자리의 영문,숫자,특수문자의 입력이 가능합니다.</span><br> <input
						type="password" name="PW" id="mypw2" class="pw"
						placeholder="비밀번호를 확인하세요." required="required" /> <font
			...
			<div class="divNAME">
				...
				<div class="NAME_2 NAME_common">
					<input type="text" name="NAME" id="myname" placeholder="이름을 입력하세요."
						required="required" />
				</div>
			</div>
			...
			<div class="divADDR">
				...
				<div class="ADDR_2 ADDR_common">
					<input type="text" name="ADDRESS" id="roadFullAddr"
						class="form-control" placeholder="주소를 검색하세요." required="required"
						disabled />
				</div>
			...
			<div class="divPHONE">
				...
				<div class="PHONE_2 PHONE_common">
					<input type="text" name="PHONE" id="myph"
						placeholder="전화번호를 '-'없이 입력하세요." required="required" />
				</div>
			</div>
			...
			<div class="divEMAIL">
				...
				<div class="EMAIL_2 EMAIL_common">
					...
					%>
					<input type="email" name="EMAIL" id="email"
						placeholder="이메일을 입력하세요." value="${naveremail }" /><br>
					<%
						}
					%>
			...
			<div class="div_Button">
				<div class="Button_1 Donation_Button">
					<input type="button" value="회원가입" id="button_t" onclick="" />
				</div>
			</div>
		</div>
	</section>
