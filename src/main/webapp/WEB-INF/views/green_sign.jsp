		...
		<div class="reg_border">
			...
			<div class="divPW">
				...
				<div class="PW_2 PW_common">
					<input type="password" name="pw" id="mypw1" class="pw"
						placeholder="비밀번호를 입력하세요." required="required" /> <br> <span
						id="pw_text">8~15자리의 영문,숫자,특수문자의 입력이 가능합니다.</span><br> <input
						type="password" id="mypw2" class="pw"
			...
			<div class="divEMAIL">
				...
				<div class="EMAIL_2 EMAIL_common">
					...
					%>
					<input type="email" name="email" id="email"
						placeholder="이메일을 입력하세요." value="${kakaoemail }" /><br>
					<%
						} else {
					%>
					<input type="email" name="email" id="email"
